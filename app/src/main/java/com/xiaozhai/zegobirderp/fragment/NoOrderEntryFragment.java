...
/**
 * Prooject name：无单扫描上架主界面
 * Created by KAKA on ${DATE}.
 */

public class NoOrderEntryFragment extends BaseFragment implements View.OnClickListener {

    private ListView lvNoOrderEntry;
    ...
    protected View initView() {
        initTile("无单扫描上架");
        isShowCommit(true);
        View view = View.inflate(mContext, R.layout.fragment_no_order_entry, null);
        lvNoOrderEntry = (ListView)view.findViewById( R.id.lv_no_order_entry );
        initListener();
        return view;
    }
    ...
    protected void initData() {
        super.initData();
        lvNoOrderEntry.setAdapter(new NoOrderEntryAdapter(mContext));
    }
    ...
    private class NoOrderEntryAdapter extends BaseAdapter {
        private final FuncDetailActivity context;
        private ArrayList<GoodsEntryBean> dataList;

        public NoOrderEntryAdapter(FuncDetailActivity context) {
